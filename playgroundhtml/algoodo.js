...
function draw() {
    ...
    // Variable Adjustment
    if ( keyboard.presses("=") || keyboard.presses("+") || keyboard.presses("-") || keyboard.presses("A") || keyboard.presses("-") || keyboard.presses("+") || keyboard.presses("-")) {
